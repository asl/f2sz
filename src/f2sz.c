...
void usage(const char *name, const char *str){
    ...
    fprintf(stderr,
            ...
            "\t%1$s any.file -o output.file.zst            Compress any.file to any.file.zst\n"
            "\t%1$s any.file -o /dev/stdout                Compress any.file to standard output\n"
            "\n"
            "Options:\n"
            ...
            "\t                   It requires libzstd >= 1.5.0 or an older version compiled with ZSTD_MULTITHREAD.\n"
